		...
		<div class="wrap mmp-wrap">
			...
			<form id="mapList" method="POST">
				...
				<div id="pagination_top" class="mmp-pagination mmp-pagination-maps">
					...
					<div>
						<button type="button" id="first_top" value="1"><img src="<?= plugins_url('images/icons/nav-first.png', __DIR__) ?>" /></button>
						<button type="button" id="previous_top" value="1"><img src="<?= plugins_url('images/icons/nav-prev.png', __DIR__) ?>" /></button>
						<button type="button" id="next_top" value="1"><img src="<?= plugins_url('images/icons/nav-next.png', __DIR__) ?>" /></button>
						<button type="button" id="last_top" value="1"><img src="<?= plugins_url('images/icons/nav-last.png', __DIR__) ?>" /></button>
					</div>
					<div>
				...
				<div id="pagination_bottom" class="mmp-pagination mmp-pagination-maps">
					...
					<div>
						<button type="button" id="first_bottom" value="1"><img src="<?= plugins_url('images/icons/nav-first.png', __DIR__) ?>" /></button>
						<button type="button" id="previous_bottom" value="1"><img src="<?= plugins_url('images/icons/nav-prev.png', __DIR__) ?>" /></button>
						<button type="button" id="next_bottom" value="1"><img src="<?= plugins_url('images/icons/nav-next.png', __DIR__) ?>" /></button>
						<button type="button" id="last_bottom" value="1"><img src="<?= plugins_url('images/icons/nav-last.png', __DIR__) ?>" /></button>
					</div>
					<div>
