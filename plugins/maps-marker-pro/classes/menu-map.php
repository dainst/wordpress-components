...
class Menu_Map extends Menu {
	...
	public function save_map() {
		...
		$settings = $mmp_settings->validate_map_settings($settings, false);
												...
												<?php if (isset($basemaps[$basemap])): ?>
													<li class="mmp-basemap" data-id="<?= $basemap ?>">
														<div>
															...
															<img class="mmp-align-middle mmp-clickable mmp-remove-basemap" src="<?= plugins_url('images/icons/red-cross.png', __DIR__) ?>" />
														</div>
													</li>
												<?php endif; ?>
											<?php endforeach; ?>
												...
												<?php if (isset($overlays[$overlay])): ?>
													<li class="mmp-overlay" data-id="<?= $overlay ?>">
														<div>
															...
															<img class="mmp-align-middle mmp-clickable mmp-remove-overlay" src="<?= plugins_url('images/icons/red-cross.png', __DIR__) ?>" />
														</div>
													</li>
												<?php endif; ?>
											<?php endforeach; ?>
										...
										<?php foreach ($filters as $id => $filter): ?>
											<li class="mmp-filter" data-id="<?= $id ?>">
												<div>
													...
													<img class="mmp-align-middle mmp-clickable mmp-remove-filter" src="<?= plugins_url('images/icons/red-cross.png', __DIR__) ?>" />
												</div>
											</li>
										<?php endforeach; ?>
									</ul>
