...
class Settings {
	...
	public function get_settings() {
		...
		return $this->validate_settings($settings, true);
	}
	...
	public function get_map_defaults() {
		...
		return $this->validate_map_settings($settings, true);
	}
	...
	public function get_marker_defaults() {
		...
		return $this->validate_marker_settings($settings, true);
	}
	 ...
	 * @since 4.0
	 */
	public function validate_settings($settings, $default_bool = true) {
		return $this->sanitize_settings($settings, $this->settings_sanity(), $default_bool);
	}
	 ...
	 * @since 4.0
	 */
	public function validate_map_settings($settings, $default_bool = true) {
		return $this->sanitize_settings($settings, $this->map_settings_sanity(), $default_bool);
	}
	 ...
	 * @since 4.0
	 */
	public function validate_marker_settings($settings, $default_bool = true) {
		return $this->sanitize_settings($settings, $this->marker_settings_sanity(), $default_bool);
	}
	 ...
	 * @param bool $default_bool Whether missing bools should use their default values or be considered false
	 */
	public function sanitize_settings($data, $sanity, $default_bool = true) {
				...
				case 'string':
					if (isset($data[$key])) {
						if ($value['allowed'] === true) {
							...
							if (in_array($data[$key], $value['allowed'])) {
								$validated[$key] = $data[$key];
							} else {
								$validated[$key] = $value['default'];
							}
	...
	public function settings_sanity() {
		...
		$settings['layarRadius'] = array(
			'type'    => 'string',
			'default' => '',
			'allowed' => true
		);
		$settings['layarUnits'] = array(
			'type'    => 'string',
			'default' => 'km',
			'allowed' => array('km', 'mile')
		);
		$settings['layarIcons'] = array(
			'type'    => 'string',
			'default' => 'mapsmarker',
			'allowed' => array('mapsmarker', 'layar_standard', 'layar_custom')
		);
		$settings['layarRefreshInterval'] = array(
			'type'    => 'absint',
			'default' => 300,
			'min'     => 10,
			'max'     => INF
		);
		$settings['layarRefreshDistance'] = array(
			'type'    => 'absint',
			'default' => 100,
			'min'     => 3,
			'max'     => INF
		);
		$settings['layarFootnote'] = array(
			'type'    => 'string',
			'default' => 'powered by www.mapsmarker.com',
			'allowed' => true
		);
	...
	public function map_settings_sanity() {
		...
		$settings['gpxChartPolyline'] = array(
			'type'    => 'bool',
			'default' => true
		);
		$settings['gpxChartPolylineColor'] = array(
			'type'    => 'string',
			'default' => '#ff0000',
			'allowed' => true
		);
		$settings['gpxChartPolylineWeight'] = array(
			'type'    => 'absint',
			'default' => '2',
			'min'     => 0,
			'max'     => INF
		);
		$settings['gpxChartPolygon'] = array(
			'type'    => 'bool',
			'default' => true
		);
		$settings['gpxChartPolygonFillColor'] = array(
			'type'    => 'string',
			'default' => '#0000ff',
			'allowed' => true
		);
		$settings['gpxChartIndicator'] = array(
			'type'    => 'bool',
			'default' => true
		);
		$settings['gpxChartIndicatorColor'] = array(
			'type'    => 'string',
			'default' => '#ff0000',
			'allowed' => true
		);
		$settings['gpxChartIndicatorWeight'] = array(
			'type'    => 'absint',
			'default' => '1',
			'min'     => 0,
			'max'     => INF
