		...
		<div class="wrap mmp-wrap">
			...
			<div class="mmp-main">
				...
				<ul>
					...
					<li>- Submenu icons by <a href="http://bijou.im/" target="_blank">Bijou</a> and <a href="http://somerandomdude.com/work/iconic/" target="_blank">Iconic</a></li>
					<li>- Personalized avatar icon by <a href="http://semlabs.co.uk/" target="_blank">David Hopkins</a></li>
					<li>- Anonymous avatar icon by <a href="http://www.iconshock.com/" target="_blank">Icon Shock</a></li>
					<li>- Map edit icon by <a href="http://www.fatcow.com/" target="_blank">FatCow Web Hosting</a></li>
					<li>- Import and export icons by <a href="http://momentumdesignlab.com/" target="_blank">Momenticons</a></li>
