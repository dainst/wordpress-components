...
function mmp_delete_data() {
	...
	$wpdb->query("DROP TABLE {$wpdb->prefix}mmp_layers");
	$wpdb->query("DROP TABLE {$wpdb->prefix}mmp_maps");
	$wpdb->query("DROP TABLE {$wpdb->prefix}mmp_markers");
	$wpdb->query("DROP TABLE {$wpdb->prefix}mmp_relationships");
